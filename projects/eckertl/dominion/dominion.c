...
int baron2(struct gameState *pState, int player, int choice1);
int minion2(struct gameState *pState, int handPos, int choice1, int choice2);
int ambassador2(int choice2, int choice1, int handPos, struct gameState *state);
int tribute2(int *tributeRevealedCards, struct gameState *pState, int currentPlayer, int nextPlayer);
int mine2(struct gameState *pState, int handPos, int choice1, int choice2);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    switch( card )
    {
        ...
        case baron:
            baron2(state, currentPlayer, choice1);
            return 0;

        case minion:
            minion2(state, handPos, choice1, choice2);
            return 0;

        case ambassador:
            ambassador2(choice2, choice1, handPos, state);
            return 0;

        case tribute:
            tribute2(tributeRevealedCards, state, currentPlayer, nextPlayer);
            return 0;

        case mine:
            mine2(state, handPos, choice1, choice2);
            return 0;
...
///////////////////Refactored Dominion Code////////////////////////////

int minion2(struct gameState *state, int handPos, int choice1, int choice2)
{
    int currentPlayer = whoseTurn(state);
...
int baron2(struct gameState *state, int currentPlayer, int choice1) {
    state->numBuys++; //Increase buys by 1!
    if (choice1 > 0)
...
int tribute2(int *tributeRevealedCards, struct gameState *state, int currentPlayer, int nextPlayer){
    int i;
...
int mine2(struct gameState *state, int handPos, int choice1, int choice2){
